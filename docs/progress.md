...
| 確認                          | 結果・証拠                                                                                                                          |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `bun --no-env-file run check` | 全体format/lint/typecheck成功。ルート7件、Python66件、Web音声単体6件、API58件成功                                                   |
...
| ブラウザー                    | 最新版の本番相当環境で14件成功。日英注文・提供・会計・OAuth同意、通知切断と復旧、確認期限、設定公開反映、文字拡大・キーボードを検証 |

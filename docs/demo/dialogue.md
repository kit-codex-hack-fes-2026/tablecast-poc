...
8シーン・52の客発話を、客の台詞、実際に指定したInworldのvoice名、再生条件、期待応答の順に読むための資料。試聴リンクは生成済みの合成客音声を開く。実有料E2Eは未実行であり、店員欄は本物の応答を記録したものではない。
...
## 8. 韓国食堂ハヌル三条店で取り分けと辛さ・卓上調理を相談する

シーンID: `ja-korean-sharing`。店舗ID: `tablecast-hanul`。客: 3名。

**開始状態と到達目標:** 韓国食堂ハヌル三条店、日本語、3名、プランなし、空カート。サムギョプサル二人前セット1個＋混合の包み野菜100円＝2,780円、海鮮チヂミ1個1,080円、お米のマッコリ1本880円・器3個、計4,740円を明示承認して1件送信する。スンドゥブは相談だけで追加しない。

**重なり区間:** `korean-05` と `korean-06`は[混合WAVを試聴](../../assets/demo/audio/overlap/ja-korean-sharing-korean-06.wav)できる。後の声は先の声の開始300ms後に入る。個別MP32本を混合版1回に置き換え、重複入力しない。

### korean-01 · 凛 / Asuka

[客音声MP3を試聴・8.688秒](../../assets/demo/audio/ja-korean-sharing/korean-01.mp3)

**再生条件:** `after_previous`。日本語、3名、プランなし、空カート。最初は相談のみで注文を追加しない。

**客の台詞**

> 三人で来ました。韓国料理は初めてです。サムギョプサルの二人前って、どのくらいの量ですか。食べ方も教えてください。

**期待応答・挙動の例（実応答ではない）**

> 豚ばら肉300グラムとサンチュ6枚の二人前セットです。焼いた肉を葉で包んでお召し上がりください。

### korean-02 · 航 / Satoshi

[客音声MP3を試聴・8.016秒](../../assets/demo/audio/ja-korean-sharing/korean-02.mp3)

**再生条件:** `after_live_response`。最初の本物の説明が終わってから再生する。

**客の台詞**

> 鉄板が熱くなりすぎたら、自分で火を弱めていいですか。お肉は自分たちで焼くんですか。

**期待応答・挙動の例（実応答ではない）**

> 火力の調整はスタッフが行います。熱い機器には触れず、お声がけください。生肉を扱う器具と食べる器具を分け、十分に加熱してください。

### korean-03 · 葵 / Hina

[客音声MP3を試聴・11.376秒](../../assets/demo/audio/ja-korean-sharing/korean-03.mp3)

**再生条件:** `after_live_response`。卓上調理の説明が終わってから再生する。

**客の台詞**

> 私は辛いものがあまり得意ではありません。スンドゥブは辛さ控えめにすると、全く辛くなくなりますか。まだ頼むかは考え中です。

**期待応答・挙動の例（実応答ではない）**

> 辛さ控えめでも唐辛子の辛味が残ります。スンドゥブはまだ追加していません。

### korean-04 · 凛 / Asuka

[客音声MP3を試聴・8.016秒](../../assets/demo/audio/ja-korean-sharing/korean-04.mp3)

**再生条件:** `after_live_response`。相談の返答終了後に再生。包み野菜の写真と選択名・追加額を画面でも確認する。

**客の台詞**

> サムギョプサルの二人前セットを一つ。包み野菜はサンチュ三枚とえごま三枚で、みそだれは別添えにしてください。

**期待応答・挙動の例（実応答ではない）**

> サムギョプサル二人前セット一つ、サンチュ3枚とえごま3枚、みそだれ別添えで、二千七百八十円です。

### korean-05 · 航 / Satoshi

[客音声MP3を試聴・4.44秒](../../assets/demo/audio/ja-korean-sharing/korean-05.mp3)

**再生条件:** `after_live_response`。サムギョプサル1セット2780円の反映後に再生する。

**客の台詞**

> 海鮮チヂミは二つ、しょうゆ酢だれでお願いします。
...
[客音声MP3を試聴・5.976秒](../../assets/demo/audio/ja-korean-sharing/korean-06.mp3)

**再生条件:** `overlap_previous`。korean-05の客音声開始から300ms後に重ねる。器3個を酒3本と誤認しない。

**客の台詞**

> お米のマッコリも一本、取り分ける器は三人分でお願いします。

**期待応答・挙動の例（実応答ではない）**

> お米のマッコリは一本、取り分ける器は三つですね。

### korean-07 · 凛 / Asuka

[客音声MP3を試聴・10.128秒](../../assets/demo/audio/ja-korean-sharing/korean-07.mp3)

**再生条件:** `after_live_response`。重なりへの本物の応答・聞き返しが終わってから再生する。

**客の台詞**

> 声が重なりましたね。サムギョプサルはさっきのセット一つ、海鮮チヂミは二つ、マッコリは一本で器が三つです。スンドゥブは頼みません。

**期待応答・挙動の例（実応答ではない）**

> セット一つ、チヂミ二つ、マッコリ一本と器三つで五千八百二十円です。スンドゥブは入っていません。

### korean-08 · 航 / Satoshi

[客音声MP3を試聴・6.936秒](../../assets/demo/audio/ja-korean-sharing/korean-08.mp3)

**再生条件:** `during_live_response`。korean-07に対する本物の店員TTS開始から600ms後に割り込む。

**客の台詞**

> すみません、チヂミは一つに減らしてください。まだ注文は送らないでください。

**期待応答・挙動の例（実応答ではない）**

> チヂミを一つへ減らし、四千七百四十円になりました。まだ送信していません。

### korean-09 · 葵 / Hina

[客音声MP3を試聴・9.672秒](../../assets/demo/audio/ja-korean-sharing/korean-09.mp3)

**再生条件:** `after_live_response`。訂正済み4740円を画面で確認し、現在版の専用固定読み上げを要求する。

**客の台詞**

> では、サムギョプサルのセット一つ、チヂミ一つ、マッコリ一本で、四千七百四十円の内容を確認してください。

**期待応答・挙動の例（実応答ではない）**

> 現在版の専用固定確認を全文読む。セット2,780円、チヂミ1,080円、マッコリ880円の計4,740円と各選択内容を含む。

### korean-10 · 凛 / Asuka

[客音声MP3を試聴・6.096秒](../../assets/demo/audio/ja-korean-sharing/korean-10.mp3)

**再生条件:** `after_live_response`。現行確認の読み上げが完了し、4740円と全選択内容の一致後に再生する。

**客の台詞**

> はい、今確認した四千七百四十円の内容で注文を送信してください。

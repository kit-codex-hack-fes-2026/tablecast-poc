...
| 技術紹介v17 | main追従の再収録。63.1秒、後半の図は継続改善 | [技術紹介](assets/films/tablecast-technical-v17.mp4) |
...
保存済みv17は修正前の比較用作例として保持する。現在の描画処理は、前の接続線の強調を消し、説明中の経路だけを滑らかに描くため、再生成するとv17とその部分の見た目が異なる。修正後の見た目は未承認であり、v18等への採用更新は次のユーザー評価で判断する。
